...
public static class InspectCodeBaselineRunHelperConstant
{
    ...
    /// </summary>
    public const string FAILED_TO_START_INSPECTCODE = "Failed to start InspectCode via any of: 'dotnet tool run jb inspectcode', 'jb inspectcode', 'InspectCode.exe', or 'inspectcode'. " +
        "Make sure JetBrains.ReSharper.GlobalTools is restored or InspectCode is available on PATH.";

    /// <summary>
    /// jb inspectcode failed.
    /// </summary>
    public const string INSPECTCODE_FAILED = "InspectCode execution failed.";

    /// <summary>
    /// jb inspectcode timed out.
    /// </summary>
    public const string INSPECTCODE_TIMED_OUT = "InspectCode execution timed out after 30 minutes.";
    ...
    /// <summary>
    /// Directory for generated SARIF reports inside .biak logs.
    /// </summary>
    public const string REPORTS_DIRECTORY = ".biak/logs/inspectcode-baseline";
