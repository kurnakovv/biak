...
* 🚧 Baseline | Create a baseline from existing diagnostics to keep legacy violations under control and enforce stricter checks for new code without fixing everything at once.
